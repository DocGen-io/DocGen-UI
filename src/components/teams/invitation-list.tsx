  ...
  return (
    <div className="space-y-4 mb-8">
      <div className="flex items-center gap-2 px-1">
        ...
        <Badge
          variant="secondary"
          className="h-5 px-1.5 min-w-[20px] justify-center bg-amber-500/10 text-amber-600 border-amber-500/20"
        >
          {invitations.length}
        </Badge>
      </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-0.5">
                <p className="text-sm font-bold tracking-tight">Join Request</p>
