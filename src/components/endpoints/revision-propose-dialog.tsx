...
import { OpenAPIEditor } from "@/components/endpoints/openapi-editor";
...
export function RevisionProposeDialog({
  name,
  data,
  onSave,
  ...
  return (
    <DialogContent className="max-w-7xl w-[95vw] max-h-[90vh] overflow-y-auto p-0 border-none bg-background/95 backdrop-blur-xl shadow-2xl custom-scrollbar">
      <div className="p-0 pb-10">
        ...
        <OpenAPIEditor title={name} initialValue={data} onSave={onSave} />
      </div>
    </DialogContent>
  );
}
