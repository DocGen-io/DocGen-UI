import { Loader2, AlertTriangle, RefreshCw, GitPullRequest, TrendingUp } from 'lucide-react';
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 space-y-4 bg-destructive/5 rounded-xl border border-destructive/10">
             ...
             <div className="space-y-1">
               ...
               <p className="text-sm text-muted-foreground px-4">There was a problem syncing with the review system.</p>
             </div>
             <Button variant="outline" size="sm" onClick={onRetry} className="border-destructive/20 text-destructive hover:bg-destructive/10">
          ...
          pendingRevisions.slice(0, 5).map((revision) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold truncate text-foreground/90">{revision.endpoint_id}</p>
